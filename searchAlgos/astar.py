...
#           monotony | type: int/float | Representa o valor da euristica (custo do caminho é irrelevante neste jogo) do ultimo estado escolhido
#
# metodos:
#
#       __bestMove | privado | Retorna a coluna do move do melhor nó ou seja o nó com euristica mais alta no caso
...
class Astar():
    ...
    #       self | type: int | Referência ao objeto Astar usado 
    #
    # return: type: int | Retorna a coluna do move do melhor nó ou seja o nó com euristica mais alta no caso
    ...
    def __bestMove(self):
        ...
        # Escolhe o melhor nó de entre os nós filhos (ou seja aquele com melhor euristica)
        ...
        for column in range(0,7):
            for line in range(5,-1,-1):
                if actualState[line][column] == '-':
                    ...
                    node.setPathCost(max(self.monotony, heuristicCalculate(node.state, self.symbol))) # Calcula e guarda a euristica do nó especifico (o custo do caminho é irrelevante neste jogi)
